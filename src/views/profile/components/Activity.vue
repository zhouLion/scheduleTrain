    ...
    <div class="post">
      <div class="user-block">
        <img
          ...
          class="img-circle"
        >
        <span class="username text-muted">用户A</span>
        <span class="description">7:30pm</span>
      </div>
      <p>此处用于填写文章内容.</p>
    ...
    <div class="post">
      <div class="user-block">
        <img
          ...
          class="img-circle"
        >
        <span class="username text-muted">用户B</span>
    ...
    <div class="post">
      <div class="user-block">
        <img
          ...
          class="img-circle"
        >
        <span class="username">用户C</span>
        <span class="description">2天前</span>
      </div>
